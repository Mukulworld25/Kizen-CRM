-- Fix process_intake_batch to not fail the entire transaction when a row is missing required fields.
-- Instead, it will skip the row and increment the v_skipped_count.
