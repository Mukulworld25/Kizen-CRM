...
export default function LeadDetail() {
  ...
  const handleStatusChange = (status: LeadStatus) => {
    ...
    if (status === 'admitted') setConvertOpen(true)
  }
        ...
        <div className="lg:col-span-3 space-y-6">
          <Card>
            ...
            <CardContent className="grid gap-4 sm:grid-cols-2 text-sm">
              <InfoField label="Mobile" value={lead.mobile} />
              <InfoField label="Email" value={lead.email} />
              <InfoField label="City" value={lead.city} />
              <InfoField label="Course" value={lead.course?.name} />
              <InfoField label="Source" value={lead.source?.replace('_', ' ')} />
              <InfoField label="Counselor" value={lead.counselor?.name} />
              <InfoField label="Parent" value={lead.parent_name} />
              <InfoField label="School/College" value={lead.school_college} />
              {lead.notes && <div className="sm:col-span-2"><InfoField label="Notes" value={lead.notes} /></div>}
            </CardContent>
          </Card>
