        ...
        <TabsContent value="profile" className="mt-4">
          <Card>
            <CardContent className="grid gap-4 p-6 sm:grid-cols-2 text-sm">
              ...
              <Field label="Batch" value={student.batch?.batch_name} />
              <Field label="Admission Date" value={student.admission_date} />
              <Field label="Parent" value={student.parent_name} />
              <Field label="School/College" value={student.school_college} />
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="progress" className="mt-4">
          <Card>
            <CardContent className="p-6">
              <Field label="Certification Status" value={student.certification_status.replace('_', ' ')} />
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
