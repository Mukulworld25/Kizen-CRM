...
export const SHEET_SOURCES: { value: string; label: string }[] = [
  { value: 'ACCA (April)', label: 'ACCA (April)' },
  { value: 'NEW ACCA PAN IND', label: 'NEW ACCA PAN IND' },
  { value: 'Free ACCA Classes', label: 'Free ACCA Classes' },
  { value: 'Ai Sensy', label: 'Ai Sensy' },
  { value: 'SMART PREP', label: 'SMART PREP' },
  { value: 'Warm leads', label: 'Warm leads' },
  { value: 'Hot Leads', label: 'Hot Leads' },
  { value: 'PU', label: 'PU' },
  { value: '11 - 12 demo class', label: '11 - 12 demo class' },
  { value: '12 Pass out CHD', label: '12 Pass out CHD' },
  { value: 'SD Leads', label: 'SD Leads' },
  { value: '12th and 1st year data', label: '12th and 1st year data' },
  { value: 'AI Leads', label: 'AI Leads' },
  { value: 'College List', label: 'College List' },
  { value: '11th 12th - April', label: '11th 12th - April' },
  { value: 'Hindi Course', label: 'Hindi Course' },
  { value: 'CUET 1', label: 'CUET 1' },
  { value: 'CUET 2', label: 'CUET 2' },
  { value: "SATINDER'S SESSION", label: "SATINDER'S SESSION" },
  { value: 'Simrat Leads', label: 'Simrat Leads' },
  { value: 'New leads', label: 'New leads' },
  { value: 'Sourav Lists', label: 'Sourav Lists' },
  { value: 'Simrat (Bcom)', label: 'Simrat (Bcom)' },
  { value: '11th & 12th', label: '11th & 12th' },
  { value: 'Vaibhav Leads', label: 'Vaibhav Leads' },
]

export const FEE_COURSE_LEVELS: { value: string; label: string }[] = [
  { value: 'ACCA KL', label: 'ACCA KL' },
  { value: 'ACCA SL', label: 'ACCA SL' },
  { value: 'ACCA PL', label: 'ACCA PL' },
  { value: 'FIA', label: 'FIA' },
  { value: '11th & 12th', label: '11th & 12th' },
